		...
		<script src="<?php echo BASE_PATH?>/js/dolphin/pipeline_error_checks.js" type="text/javascript"></script>
		...
		<script src='<?php echo BASE_PATH?>/js/dolphin/additional_pipeline_methods.js' type="text/javascript"></script>
	</body>
</html>
