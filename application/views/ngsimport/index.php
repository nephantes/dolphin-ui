								...
								<form role="form" enctype="multipart/form-data" action="ngsimport/process" method="post">
									<div class="box-body">
										<div class="form-group">
											...
											<a href="http://biocore.umassmed.edu/downloads/example_template.xls">Download example excel input for files in a single directory.</a>
											<br>
											<a href="http://biocore.umassmed.edu/downloads/example_template_multi_dirs.xls">Download example excel input for files in multiple directories.</a>
										</div>
									</div><!-- /.box-body -->
									<div class="box-body">
										<div class="form-group">
