...
(function(window, $) {
  ...
  _F.initPagination = function(opts){
    ...
    var html = '<div id="st_pagination" class="'+ this.paging_opts.container_class  +'"></div>';
  ...
  _F.addPerPage = function(){
    ...
    html = ['<select id="st_num_search" size="1" name="per_page" class="'+ this.paging_opts.per_page_class +'">'];
