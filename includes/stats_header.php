<?php
    require_once("php/stats/ui/uifuncs.php");
    $ui = new uifuncs();
?>
        ...
        <!--[if lt IE 9]>
		<script src="<?php echo BASE_PATH?>/css/html5shiv/3.7.0/html5shiv.min.js"></script>
		<script src="<?php echo BASE_PATH?>/css/respond/1.3.0/respond.min.js"></script>
        <![endif]-->
