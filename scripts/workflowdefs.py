...
stepMCall='stepMCall%(sep)s@RUNMCALL -binpath @BIN/mcall -previous bsmap -sampleconditions @MCONDS -fields @MFIELDS -params @MCALLPARAM -ref @GENOMEFASTA -o @OUTDIR -servicename stepMCall -j @JOB%(sep)s30'
