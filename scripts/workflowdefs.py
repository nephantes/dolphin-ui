...
stepGetTotalReads = 'stepGetTotalReads%(sep)s@RUNGETTOTALREADS -b @BARCODES -g %(rungroup)s -p @SPAIRED -o @OUTDIR -u @USERNAME -j @JGEN%(sep)s10'
stepBackupS3 = 'stepBackupS3%(sep)s@RUNBACKUPS3 -b @BARCODES -g %(rungroup)s -p @SPAIRED -o @OUTDIR -u @USERNAME -j @JGEN%(sep)s10'
