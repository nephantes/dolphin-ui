...
stepRSEM = 'stepRSEM%(sep)s@RUNRSEM -c @RSEMCMD -r %(rsemref)s -d @SPAIRED -g %(genome_bam)s -pa @PARAMSRSEM -pr %(previousrsem)s -o @OUTDIR -b @BOWTIEPATH -s stepRSEM -j @JOB%(sep)s240'
